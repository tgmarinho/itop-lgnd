  ...
  return (
    <>
      <div className="flex flex-col gap-2 rounded-md bg-background p-2">
        <GridThreeColumns title="Senderista" className="items-center">
          <Fieldset
      ...
      <div className="flex flex-col gap-2 rounded-md bg-background p-2">
        <GridThreeColumns title="Legendários" className="items-center">
          <Fieldset
            legend="Máximo de vagas"
          ...
          <Fieldset
            legend="Valor Legendário Certificado"
          ...
          <Fieldset
            legend="Valor Legendário não Certificado"

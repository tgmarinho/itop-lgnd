...
export const SelectVehicleLegendary = ({ row }: SelectVehicleProps) => {
  ...
  const { data: vehicles } = api.vehicle.getVehiclesByLegendary.useQuery(
    {
  ...
  return (
    <SelectVehiclePopover
      ...
      description={(selectedValue) =>
        `Certeza que deseja atribuir a viatura ${selectedValue} ao legendário ${row.original.nome}?`
      }
    />
  );
};
